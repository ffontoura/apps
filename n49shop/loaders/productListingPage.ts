...
import { ProductBaseN49Shop } from "../utils/types.ts";
...
export interface Props {
   ...
   */
  limit: number;
  // Sort in N49Short do not work when using q in query params
  // sort?: N49ShopSort;
...
/**
 * @title N49Shop Integration - Product Listing Page
 */
async function loader(
  ...
  // Sort in N49Short do not work when using q in query params
  // const sort = props.sort || url.searchParams.get("sort") as N49ShopSort;
  ...
  return {
    ...
    // sortOptions: NUVEMSHOP_SORT_OPTIONS, Sort in N49Short do not work when using q in query params
    sortOptions: [],
    // filters: toFilters(
    //   result || [],
    ...
    //   req.url,
    // ),
    filters: [], // N49Shop right now don't receive product variant query params in products route
  };
}
