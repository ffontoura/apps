...
export interface Account {
  ...
  /**
   * @description The id of the store in n49shop. Check: https://tiendanube.github.io/api-documentation/intro#languages-and-internationalization
   */
  storeId: string;
}

// https://tiendanube.github.io/api-documentation/resources/product
export interface ProductBaseN49Shop {
  id: number;
  name: LanguageTypes;
...
export interface InstallmentsInfo {
  "N49 Pago": { [key: string]: InstallmentData };
}
